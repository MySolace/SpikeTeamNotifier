...
class Version20151028100830 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('UPDATE spiker_group SET enabled=1 WHERE enabled=0');
        $this->addSql('INSERT into spiker_group VALUES (null, "Group 5", 1, null), (null, "Group 6", 1, null), (null, "Group 7", 1, null)');
    }
