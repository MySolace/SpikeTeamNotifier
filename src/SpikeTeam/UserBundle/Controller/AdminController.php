    ...
    public function adminEditAction($username, Request $request)
    {
        ...
        if ($currentUser->getUsername() == $username || $securityContext->isGranted('ROLE_SUPER_ADMIN')) {
            ...
            if ($form->get('remove')->isClicked()) {
                return $this->redirect($this->generateUrl('spiketeam_user_admin_admindelete', array('username' => $username)));
            }
            ...
            return $this->render($this->generateUrl('spiketeam_user_admin_adminall '));
        }
    }
